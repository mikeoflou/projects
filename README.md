...
This is a custom dashboard and browser extension that I use as my personal "New Tab" landing page.
...
2. Load it as an "Unpacked Extension" in `chrome://extensions/`.
